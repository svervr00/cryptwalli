...
//   { label: "Wallet", icon: "/icons/wallet.svg" },
//   { label: "Transactions", icon: "/icons/transactions.svg" },
//   { label: "History", icon: "/icons/history.svg" },
...
//         <div
//           className="fixed inset-0 bg-[#5c4efc] lg:hidden z-10"
...
//           </div>
//           <div
//             className="relative w-auto mx-3 border font-light text-[14px] px-[10px] mt-4
...
//               <button
//                 key={item.label}
//                 className="flex items-center space-x-3 p-2 hover:bg-white/10 rounded-md"
//               >
...
// SideNav updated for navigation to /dashboard, /wallet, etc.
